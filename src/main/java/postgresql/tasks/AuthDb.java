...
public class AuthDb {
    ...
    @SneakyThrows
    public static String getAuthToken(String email) throws SQLException, JSchException {
    ...
    @SneakyThrows
    public static String getPin(String email) throws SQLException, JSchException {
        establishDatabaseConnection();
